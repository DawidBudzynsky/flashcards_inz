...
const SetsList: React.FC<SetsListProp> = ({ sets }) => {
    ...
    const handleCreateNewSet = () => {
        // Navigate to the create set page with the inFolder query parameter
    ...
    return (
        <div className="modal-box w-11/12 max-w-3xl">
            ...
            <div className="flex justify-between py-3">
                <h3 className="font-bold text-lg mb-4 flex-1">Available Sets</h3>
                <button
                    className="btn flex-1"
                    onClick={handleCreateNewSet}>Create new set for this folder
                </button>
            </div>
